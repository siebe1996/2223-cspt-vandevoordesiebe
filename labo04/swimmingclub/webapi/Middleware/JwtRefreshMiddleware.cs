...
namespace webapi.Middleware
{
    public class JwtRefreshMiddleware
    {
        ...
        public async Task Invoke(HttpContext context, IMemberRepository _memberRepository)
        {
                ...
                try
                {
                    ...
                    if (expiryTimeUnix != null)
                    {
                        ...
                        if (expiryTimeUtc <= DateTime.UtcNow)
                        {
                            ...
                            string refreshToken = context.Request.Cookies["Swimmingclub.RefreshToken"]; 
                            var refreshedToken = await _memberRepository.RenewToken(refreshToken, context.Connection.LocalIpAddress.MapToIPv4().ToString());
                            ...
                            context.Response.Cookies.Append("Swimmingclub.RefreshToken", refreshedToken.RefreshToken, cookieOptions);
                        }
                    }
                }
